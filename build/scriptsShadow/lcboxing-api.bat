...
set CLASSPATH=%APP_HOME%\lib\lcboxing-api-1.0.0.jar

@rem Execute lcboxing-api
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LCBOXING_API_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%LCBOXING_API_EXIT_CONSOLE%" exit 1
exit /b 1
